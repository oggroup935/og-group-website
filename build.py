...
SUB={
 ...
 '__SCREENS__':open('screens.html').read(),
 '__LEAFLET_CSS__':open('node_modules/leaflet/dist/leaflet.css').read(),
 '__LEAFLET_JS__':open('node_modules/leaflet/dist/leaflet.js').read(),
